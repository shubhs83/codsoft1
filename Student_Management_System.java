...
7. Exit
Enter your choice: 1
Enter Name: shubham rajendra wankhede
...
7. Exit
Enter your choice: 1
Enter Name: rahul rajendra wankhede
Enter Roll Number: 165
Enter Grade: a
Student added successfully.
Student Management System Menu:
1. Add a Student
...
7. Exit
Enter your choice: 1
Enter Name: sai santosh wankhede
Enter Roll Number: 166
Enter Grade: b
Student added successfully.
Student Management System Menu:
1. Add a Student
...
7. Exit
Enter your choice: 2
Enter Roll Number to Remove: 166
...
7. Exit
Enter your choice: 3
Enter Search Query: shubham rajendra wankhede
Matching Students:
Name: shubham rajendra wankhede
Roll Number: 164
Grade: a
...
7. Exit
Enter your choice: 5
Enter File Name to Save Students: student data
Students saved to student data
Student Management System Menu:
1. Add a Student
2. Remove a Student
3. Search for a Student
...
7. Exit
Enter your choice: 6
Enter File Name to Load Students: student
Error loading students: student (The system cannot find the file specified)
Student Management System Menu:
1. Add a Student
2. Remove a Student
3. Search for a Student
